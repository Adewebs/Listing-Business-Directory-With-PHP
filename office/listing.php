<?php 
$page_title = "Office | Business Directories";
include 'head.php'; 
$activePage = 'listing.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['edit_listing'])) {
    ...
    if (!empty($updateFields)) {
        $updateQuery = "UPDATE listed_business SET " . implode(', ', $updateFields) . " WHERE id = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_listing'])) {
    $id = $_POST['id'];
    $deleteQuery = "DELETE FROM listed_business WHERE id = '$id'";
...
$totalQuery = "SELECT COUNT(*) AS total FROM listed_business";
$totalResult = $conn->query($totalQuery);
$total = $totalResult->fetch_assoc()['total'];
$total_pages = ceil($total / $items_per_page);

// Fetch business listings with pagination
$query = "SELECT * FROM listed_business LIMIT $items_per_page OFFSET $offset";
                            ...
                            <div class="col-xl-12 mb-4">
                                <div class="row d-lg-flex justify-content-between align-items-center">
                                    <div class="col-md-9">
                                        ...
                                        <p>Manage All Listed Business here.</p>
                                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card-lines-tab">
                                    <ul class="nav nav-pills card-header">
                                        <li class="nav-item">
                                            <a class="nav-link active">All Listings</a>
                                        </li>
                                    </ul>
